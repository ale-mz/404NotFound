...
_lr_action_items = {'ROUTE_HEADER':([0,2,3,10,11,16,17,20,21,23,25,26,32,33,34,49,54,56,68,72,77,80,84,86,95,103,108,110,112,117,124,125,135,139,146,147,148,150,151,154,157,158,174,],[5,5,5,32,-47,-7,-9,-12,-14,-18,-20,-23,-45,-46,-48,-36,-6,-16,-25,-38,-5,-8,-29,-10,-33,-17,-11,-24,-19,-32,-39,-21,-28,-27,-30,-15,-22,-31,-35,-26,-13,-34,-37,]),'$end':([0,1,2,3,4,8,9,16,17,20,21,23,25,26,32,49,54,56,68,72,77,80,84,86,95,103,108,110,112,117,124,125,135,139,146,147,148,150,151,154,157,158,174,],[-49,0,-49,-3,-4,-1,-2,-7,-9,-12,-14,-18,-20,-23,-45,-36,-6,-16,-25,-38,-5,-8,-29,-10,-33,-17,-11,-24,-19,-32,-39,-21,-28,-27,-30,-15,-22,-31,-35,-26,-13,-34,-37,]),'WEEK_DAY':([0,2,3,16,17,20,21,23,25,26,32,49,54,56,68,72,77,80,84,86,95,103,108,110,112,117,124,125,135,139,146,147,148,150,151,154,157,158,174,],[7,7,7,-7,-9,-12,-14,-18,-20,-23,-45,-36,-6,-16,-25,-38,-5,-8,-29,-10,-33,-17,-11,-24,-19,-32,-39,-21,-28,-27,-30,-15,-22,-31,-35,-26,-13,-34,-37,]),'VPN_IP':([5,10,11,33,34,152,160,163,],[12,12,-47,-46,-48,156,161,164,]),'PLUGIN_MSG':([6,28,38,68,76,94,101,],[13,48,60,93,-44,-40,-43,]),'SBIN_IP_MSG':([6,76,101,],[14,-44,-43,]),'TUN_TAP_MSG':([6,76,101,],[16,-44,-43,]),'SIGTERM_MSG':([6,76,101,],[17,-44,-43,]),'OPEN_VPN_MSG':([6,76,101,],[18,-44,-43,]),'LIB_VER_MSG':([6,76,87,101,],[19,-44,108,-43,]),'SYS_MSG':([6,28,38,76,94,101,],[20,49,57,-44,-40,-43,]),'CRYPTO_MSG':([6,59,76,101,],[21,84,-44,-43,]),'ROUTE_GATEWAY':([6,76,101,],[22,-44,-43,]),'IP_PROTOCOL':([6,76,101,],[23,-44,-43,]),'CONN_MSG':([6,28,38,47,76,94,101,],[24,47,59,70,-44,-40,-43,]),'TCP_MSG':([6,76,101,],[25,-44,-43,]),'IFCONFIG_END':([6,76,101,],[26,-44,-43,]),'IP':([6,12,14,22,25,44,46,55,65,70,76,79,81,97,99,101,123,142,149,156,161,165,166,],[15,34,36,43,45,67,69,80,90,96,-44,103,104,116,118,-43,136,151,155,159,162,166,167,]),'CARNET':([6,49,58,75,76,82,101,129,],[29,29,29,29,-44,29,-43,29,]),'PROF':([6,49,58,75,76,82,101,129,],[30,30,30,30,-44,30,-43,30,]),'MONTH':([7,18,40,],[31,39,62,]),'DIR':([13,48,60,70,78,93,],[35,73,85,95,102,114,]),'DAY':([14,19,31,37,39,],[37,40,51,56,61,]),'PORT':([15,45,69,104,118,136,155,],[38,68,94,121,131,146,158,]),'SPECIAL_CHAR':([20,29,30,35,38,50,53,57,83,96,100,102,105,113,115,116,121,132,133,167,169,171,],[41,-41,-42,53,58,75,78,82,106,115,119,120,122,127,129,130,134,143,144,168,170,172,]),'VAR_SET':([20,24,35,41,64,66,67,71,73,85,88,90,114,126,127,130,134,144,172,],[42,44,52,63,89,91,92,97,98,107,109,111,128,137,138,141,145,153,173,]),'SLASH':([27,29,30,43,74,140,],[46,-41,-42,65,99,149,]),'SENT_CNT':([28,94,],[50,-40,]),'IP_RNG':([36,],[54,]),'PEER':([36,54,106,168,],[55,79,123,169,]),'VAR_VAL':([42,44,52,63,89,91,92,98,107,109,111,128,137,138,141,145,153,173,],[64,66,77,88,110,112,113,117,124,125,126,139,147,148,150,154,157,174,]),'POOL_RET':([47,],[71,]),'CIPHER':([47,170,],[72,171,]),'CLOCK':([51,],[76,]),'FLAGS':([57,120,],[81,133,]),'YEAR':([61,62,76,],[86,87,101,]),'COLON':([119,131,],[132,142,]),'CN_SET':([122,],[135,]),'ROUTE_FLAG':([143,159,162,],[152,160,163,]),'TOPOLOGY':([164,],[165,]),}
...
_lr_goto_items = {'main_rule':([0,2,3,],[1,8,9,]),'route_identifiers':([0,2,3,],[2,2,2,]),'log_line':([0,2,3,],[3,3,3,]),'empty':([0,2,3,],[4,4,4,]),'date':([0,2,3,],[6,6,6,]),'key_value_list':([5,],[10,]),'key_value':([5,10,],[11,33,]),'id':([6,49,58,75,82,129,],[27,74,83,100,105,140,]),'userid':([6,],[28,]),}
...
_lr_productions = [
  ...
  ('log_line -> date userid SENT_CNT SPECIAL_CHAR id SPECIAL_CHAR COLON SPECIAL_CHAR ROUTE_FLAG VPN_IP IP ROUTE_FLAG VPN_IP IP ROUTE_FLAG VPN_IP TOPOLOGY IP IP SPECIAL_CHAR PEER SPECIAL_CHAR CIPHER SPECIAL_CHAR VAR_SET VAR_VAL','log_line',26,'p_log_line','parser.py',301),
  ...
  ('userid -> id SLASH IP PORT','userid',4,'p_userid','parser.py',309),
  ('id -> CARNET','id',1,'p_id','parser.py',315),
  ('id -> PROF','id',1,'p_id','parser.py',316),
  ('date -> WEEK_DAY MONTH DAY CLOCK YEAR','date',5,'p_date','parser.py',322),
  ('date -> WEEK_DAY MONTH DAY CLOCK','date',4,'p_date','parser.py',323),
  ('route_identifiers -> ROUTE_HEADER key_value_list ROUTE_HEADER','route_identifiers',3,'p_route_identifiers','parser.py',328),
  ('key_value_list -> key_value_list key_value','key_value_list',2,'p_key_value_list','parser.py',332),
  ('key_value_list -> key_value','key_value_list',1,'p_key_value_list','parser.py',333),
  ('key_value -> VPN_IP IP','key_value',2,'p_key_value','parser.py',337),
