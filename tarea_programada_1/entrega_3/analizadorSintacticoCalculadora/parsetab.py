...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','calculadora.py',60),
  ('statement -> expression','statement',1,'p_statement_expr','calculadora.py',64),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','calculadora.py',68),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','calculadora.py',69),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','calculadora.py',70),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','calculadora.py',71),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calculadora.py',78),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calculadora.py',82),
  ('expression -> NUMBER','expression',1,'p_expression_number','calculadora.py',86),
  ('expression -> NAME','expression',1,'p_expression_name','calculadora.py',90),
]
